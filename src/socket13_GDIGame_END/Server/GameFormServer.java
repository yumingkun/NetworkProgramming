...
public class GameFormServer extends JFrame {
...
//			public void run() {
//				try {
//					GameFormServer frame = new GameFormServer();
...
//	}
	 ...
	 * Create the frame.
	 */
	public GameFormServer(String sUserB,String sUserW,int chessType,Server sfm) {
		this.sfm=sfm;
